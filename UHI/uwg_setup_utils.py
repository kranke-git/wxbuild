...
# City / EPW discovery
# -----------------------------
def list_cities(wxbuild_root: str | Path) -> list[str]:
...
def build_initialize_residential(
    ...
    """
    Writes initialize_residential.uwg using UWG's template file.
    Removes existing building stock rows and inserts:
    ...
    # Remove existing building stock rows and insert one residential row
