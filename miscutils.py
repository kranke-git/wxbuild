...
def swapMonthTmy( tmy3_mod, idxmonth, avgShift = {'dbt': 0, 'rh': 0, 'pres':0, 'u':0, 'v':0}, swapYears = None ):
    """
        ...
        Args:
            ...
            avgShift (dict, optional): Dictionary containing the average shifts for each variable. Defaults to {'dbt': 0, 'rh': 0, 'pres':0, 'u':0, 'v':0}.
